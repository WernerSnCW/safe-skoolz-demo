...
const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    narrative: [
      "Luna reports being bullied by Oliver and Noah. The school intervenes, but word gets out.",
      "Oliver and Noah start calling Luna a \"snitch\" in corridors. The mocking becomes public.",
    ...
    whatSafeskoolzShows: [
      { label: "Incident chain", detail: "Initial incidents: Luna victim, Oliver+Noah perpetrators. Follow-on incidents: Luna and Emily as victims, Ethan/Oliver/Noah as perpetrators, with \"retaliation\" noted." },
      ...
      { label: "Pattern alerts", detail: "Group targeting on Luna. Repeat perpetrator on Oliver and Noah. Staff notes reference \"snitch\" language." },
    ],
    interventions: [
      ...
      "Stronger sanctions for Oliver, Noah, and Ethan focused specifically on retaliatory behaviour as a separate serious offence.",
