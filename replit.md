...
- **How It Works Page:** Public page at `/how-it-works` (no login required). Interactive multi-perspective story walkthrough following Sofia's bullying case through 5 weeks (Week 1-4, Week 8). Users switch between 4 perspectives: Sofia (pupil), Sofia's mum (parent), Ms Rivera (teacher), Mrs Chen (coordinator). Each perspective shows the character's experience and what happens in safeskoolz at each stage. Shows pattern detection, alerts, intervention, and recovery. Links to demo login and newsletter. Accessible from login page via purple "See how it works" banner. Also shows summaries of 4 additional stories (Luna, Liam, Mia, Year 9 misogyny).
